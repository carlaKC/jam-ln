...
impl IncomingChannel {
    pub(super) fn new(
        ...
        utilization_start: Option<(i64, i64, Instant)>,
    ...
    pub(super) fn utilization_values(
        &mut self,
        access_instant: Instant,
    ) -> Result<(i64, i64), ReputationError> {
        Ok((
            self.utilization
                .slot_utilization
...
pub struct ChannelUtilization {
    slot_utilization: DecayingAverage,
    liquidity_utilization: DecayingAverage,
}

impl ChannelUtilization {
    pub fn new(
        period: Duration,
        start_values: Option<(i64, i64, Instant)>,
    ) -> Result<Self, ReputationError> {
    ...
    pub fn add_htlc(
        ...
        self.slot_utilization.add_value(1, update_instant)?;
