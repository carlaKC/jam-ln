...
struct TrackedChannel {
    ...
    channel_revenue: RevenueAverage,
}
...
impl ReputationManager for ForwardManager {
            ...
            Entry::Vacant(v) => {
                ...
                let revenue = match &channel_reputation {
                    Some(channel) => {
                        ...
                        revenue.add_value(channel.revenue, add_ins)?;
                        revenue
                    }
    ...
    fn resolve_htlc(
        ...
        // If the htlc was settled, update only the incoming channel's revenue.
            ...
            reputations.insert(
                *scid,
                ChannelSnapshot {
                    ...
                    revenue: channel.channel_revenue.value_at_instant(access_ins)?,
                },
            );
        }
...
mod tests {
    ...
    fn test_add_and_remove_channel() {
        ...
        assert!(channels.get(&1).unwrap().revenue == 500);
